...
const AuthenticationContextProvider = ({ children }) => {
  ...
  const [user, setUser] = useState(
        {"id": "", "token": "", "name": "", "username": "", "email": "", "password": "", "gdpr": "false", "userType": ""});   
 ...
 const saveUser = async (value) => {
  ...
  const loadUser = async () => {
    ...
    try {
      ...
      setUser({"id": "", "token": "", "name": "", "username": "", "email": "", "password": "", "gdpr": "false", "userType": ""});      
    } catch (err) {
      console.log('error loading users session', err);
      setIsLoading(false);
    }
...
//userSignup({"email": email, "name": name, "password": password, "userType": "USER", "username": userName})
  ...
  return <AuthenticationContext.Provider 
    value={{ user, setSession: addSession, userReg, setUserRegister: addUserReg, noRegister: removeReg, onLogout: noSession, users, status, 
